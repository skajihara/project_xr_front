  ...
  export const mockAccounts: Account[] = [
    {
      ...
      bio: '最近はVue.jsを学習中です。',
      icon: '/icons/user/myicon.svg',
      header_photo: '/images/header/h01.jpg',
      location: '東京都',
      birthday: '1985-05-23',
    ...
    },
    {
      ...
      bio: 'コーディング中………',
      icon: '/icons/user/myicon.svg',
      header_photo: '/images/header/h02.jpg',
      location: '大阪府',
      birthday: '1990-09-12',
    ...
    },
    {
      ...
      icon: '/icons/user/kkrn_icon_user_12.svg',
      header_photo: '/images/header/h03.jpg',
      location: '愛知県',
      birthday: '1988-04-10',
    ...
    },
    {
      ...
      icon: '/icons/user/kkrn_icon_user_14.svg',
      header_photo: '/images/header/h04.jpg',
      location: '神奈川県',
      birthday: '1992-11-01',
    ...
    },
    {
      ...
      icon: '/icons/user/kkrn_icon_user_3.svg',
      header_photo: '/images/header/h05.jpg',
      location: '千葉県',
      birthday: '1985-03-13',
